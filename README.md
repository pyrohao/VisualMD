...
| 功能 | 描述 |
|------|------|
| **编辑器增强** | Monaco/CodeMirror 替换 textarea，支持语法高亮、补全 |
| **GitHub 同步** | 纯前端实现，OAuth + GitHub API 同步文档 |
| **导出优化** | 支持更多导出格式（PDF、Word） |

### 🟠 较难

| 功能 | 描述 |
|------|------|
| **VS Code 插件** | 将可视化编辑能力集成到 VS Code |
| **移动端适配** | 响应式布局，支持平板设备 |
| **插件系统** | 支持自定义插件扩展 |
