...
describe('agent runtime', () => {
  ...
  it('stores assistant text and stops', async () => {
    vi.spyOn(AIService.prototype, 'chatMessages').mockResolvedValueOnce('Done')
  ...
  it('executes tool calls and continues to final text', async () => {
    vi.spyOn(AIService.prototype, 'chatMessages')
  ...
  it('stops on unknown tools', async () => {
    vi.spyOn(AIService.prototype, 'chatMessages').mockResolvedValueOnce(
  ...
  it('stops after the tool loop limit', async () => {
    vi.spyOn(AIService.prototype, 'chatMessages').mockResolvedValue(
